...
const Terms = () => {
  useHeaderRouter({ title: "Conditions générales" });
  return (
    <ScrollView
    ...
    >
      ...
      <ThemedView style={styles.section}>
        ...
        <ThemedText type="default" style={styles.content}>
          ...
          l’application, nous en faisons juste la conservation sur nos serveurs.
          Vos informations personnelles et commerciales ne seront ni vendues, ni
          échangées, ni transférées, ou données à une autre société pour
        ...
        <ThemedText type="default" style={styles.content}>
          ...
          personne, violations de nos conditions d’utilisation, ou quand la loi
          nous y contraint. Même dans ces cas, votre accord préalable sera
      ...
      <ThemedView style={styles.section}>
        ...
        <ThemedText type="default" style={styles.content}>
          ...
          informations sensibles transmises via l’application. Nous protégeons
          également vos informations hors ligne. Pour plus de confidentialités
          nos employés opérant dans votre pays d’exercice ne sont pas autorisées
          à avoir accès à ces informations. Seuls les employés de nos filiales
          d’autres peuvent pourront en cas de besoin y avoir accès pour des
          besoins d’assistance demandées par vous-mêmes.
        </ThemedText>
      </ThemedView>
      <ThemedView style={styles.section}>
        <ThemedText type="bold" style={styles.title}>
        ...
        <ThemedText type="default" style={styles.content}>
          ...
          personnelle. Le désabonnement peut se faire par vous à tout moment en
          envoyant un email à notre service commercial. La non utilisation de
          l’application sur une longue durée pourrait aussi s’apparenter à un
          désabonnement
        </ThemedText>
      </ThemedView>
      <ThemedView style={styles.section}>
